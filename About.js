    ...
    <div id="About" className="text-darkPurple text-center bg-slate-200 flex flex-col items-center">
      <div className="container mx-auto px-10">
        ...
        <div className="flex flex-col gap-5 md:text-left">
          ...
          <a href={pdf} target="_blank" rel="noopener noreferrer"  download className="self-center md:self-start "><button className="hover:scale-105 transition ease-in-out text-purple font-bold border-2 border-purple rounded-md py-3 px-10  flex items-center justify-center gap-2"><CloudDownloadIcon className="w-5 h-5 " />MY RESUME</button></a>
        </div>
